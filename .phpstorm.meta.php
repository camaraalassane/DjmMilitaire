...
'dashboard.export-proposables-annee-n','dashboard.export-proposables-annee-n1','dashboard.export-retraites-annee-n','dashboard.export-retraites-annee-n1','alertes.marquer-vue',
'alertes.index','alertes.marquer-tout-vue','eligibilites.index','eligibilites.export','grades.index',
'grades.show','certificats.index','certificats.show','certificats.create','certificats.store',
'certificats.edit','certificats.update','certificats.destroy','militaires.index','militaires.create',
'militaires.store','militaires.show','militaires.edit','militaires.update','militaires.destroy',
'militaires.import','militaires.import.process','militaires.export.template','profile.edit','profile.update',
